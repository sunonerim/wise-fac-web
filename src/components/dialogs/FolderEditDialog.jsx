...
export default function FolderEditDialog({  open, onClose  }) {
    ...
    <>
      <Dialog
        ...
        <DialogContent dividers>
            <TextField id="outlined-basic" label="폴더 이름" variant="outlined" sx={{m:1, width: '80ch'}} value={folderName} onChange={handleFolderNameChange} autoFocus/>
        </DialogContent>
